...
while ($row =& $results->fetchRow()){
	$counts = $row[0];
	$sql_update = "UPDATE `AOE`.`host_network_species` SET `coll_total_i` = '$counts' where `i_species_id`='$i_species_id'";
	$DB->query($sql_update);
	}
	return $counts;	
...
function coll_percent($coll_total_i,$coll_number_same_h,$h_species_id,$i_species_id){
	...
	$sql_update = "UPDATE `AOE`.`host_network_species` SET `coll_percent` = '$rounded_percent' where `i_species_id`='$i_species_id' AND `h_species_id`='$h_species_id'";
...
while ($row =& $results->fetchRow()){
	$counts = $row[0];
	$sql_update = "UPDATE `AOE`.`host_network_species` SET `coll_number_same_h` = '$counts' where `i_species_id`='$i_species_id' AND `h_species_id`='$h_species_id'";
	$DB->query($sql_update);
	}
	return $counts;	
}
...
while ($row =& $results->fetchRow()){
	$counts = $row[0];
	$sql_update = "UPDATE `AOE`.`host_network_species` SET `h_n_specimens` = '$counts' where `i_species_id`='$i_species_id' AND `h_species_id`='$h_species_id'";
	$DB->query($sql_update);
	}
	return $counts;	
}
...
while ($row =& $results->fetchRow()){
	$counts = $row[0];
	$sql_update = "UPDATE `AOE`.`host_network_species` SET `i_j_same_col` = '$counts' where `i_species_id`='$i_species_id' AND `h_species_id`='$h_species_id'";
	$DB->query($sql_update);
	}
	return $counts;	
}
...
while ($row =& $results->fetchRow()){
	$counts = $row[0];
	$sql_update = "UPDATE `AOE`.`host_network_species` SET `h_voucher` = '$counts' where `i_species_id`='$i_species_id' AND `h_species_id`='$h_species_id'";
	$DB->query($sql_update);
	}
	return $counts;	
